...
namespace z7::ui::gui {
    ...
    public:
        explicit CompressDialog(CompressCommandOptions const& initial, QWidget* parent = nullptr);
    ...
    private:
        void build_ui();
        void populate_from_initial(CompressCommandOptions const& initial);
        ...
        void set_archive_fields_from_path(QString const& full_path);
        ...
        QString initial_or_saved_archive_type(CompressCommandOptions const& initial) const;
        bool saved_show_password() const;
        bool initial_or_saved_encrypt_headers(CompressCommandOptions const& initial) const;
        void apply_persistent_format_options(QString const& format_id, CompressCommandOptions const* explicit_options);
        void save_current_format_settings() const;
        void save_format_settings(QString const& format_id) const;
