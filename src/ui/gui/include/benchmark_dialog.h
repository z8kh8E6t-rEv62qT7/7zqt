...
namespace z7::ui::gui {
    ...
    public:
        explicit BenchmarkDialog(BenchmarkCommandOptions const& initial, QWidget* parent = nullptr);

        BenchmarkCommandOptions options() const;
        int last_exit_code() const;
        void dispatch_operation_event(z7::app::OperationEvent const& event);
    ...
    private:
        ...
        void stop_benchmark();
        void start_benchmark_pass(z7::app::BenchmarkRequest const& request);
        void on_benchmark_pass_finished(z7::app::OperationOutcome const& outcome);
        void finalize_benchmark_run(z7::app::OperationOutcome const& outcome);
        void reset_result_view();
        void reset_log_view();
        void set_running(bool running);
        void append_log_line(QString const& line);
        void handle_operation_event(z7::app::OperationEvent const& event);
        void apply_typed_snapshot(z7::app::BenchmarkTypedSnapshot const& snapshot);
        void apply_typed_summary(z7::app::BenchmarkTypedSummary const& summary);
