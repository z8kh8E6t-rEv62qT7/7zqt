...
namespace z7::ui::gui::gui_task_runner_shared {
    ...
    struct ArchiveExportTaskOptions {
        ...
        z7::app::ExtractZoneIdMode zone_id_mode = z7::app::ExtractZoneIdMode::kNone;
        QString password;
    };
    ...
    using PasswordPromptParentProvider = std::function<z7::ui::runtime_support::TaskProgressDialogBase*()>;
