...
namespace z7::ui::filemanager {
    ...
    public:
        explicit TempFilesDialog(QString const& temp_root_path, QWidget* parent = nullptr);
    ...
    private:
        ...
        void restore_selection_and_focus(QStringList const& selected_names, QString const& focused_name);
        ...
        void on_context_menu(QPoint const& pos);
        ...
        bool open_path_externally_with_warning(QString const& path);
        int row_for_entry_name(QString const& name) const;
