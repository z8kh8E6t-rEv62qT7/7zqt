    ...
    void MainWindow::open_archive_entries_outside_for_panel(int panel_index, QStringList const& entries) {
        ...
        start_archive_source_extract_task(
            ...
            [this, temp_dir, entries, command_caption](
                ...
                auto build_session = [&](QStringList const& launched_paths) {
                ...
                OpenOutsideLaunchResult const launch_result = launch_open_outside(extracted_paths, temp_dir->path());
                ...
                QSharedPointer<ArchiveTempSession> session = build_session(launch_result.launched_paths);
