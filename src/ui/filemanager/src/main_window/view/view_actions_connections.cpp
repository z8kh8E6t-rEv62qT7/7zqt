...
namespace z7::ui::filemanager {
    ...
    void MainWindow::setup_connections() {
        ...
        connect(open_inside_one_action_, &QAction::triggered, this, &MainWindow::on_open_inside_one_requested);
        connect(open_inside_parser_action_, &QAction::triggered, this, &MainWindow::on_open_inside_parser_requested);
        ...
        connect(alternate_streams_action_, &QAction::triggered, this, &MainWindow::on_alternate_streams_requested);
        ...
        connect(select_by_type_action_, &QAction::triggered, this, &MainWindow::on_select_by_type_requested);
        connect(deselect_by_type_action_, &QAction::triggered, this, &MainWindow::on_deselect_by_type_requested);
        ...
        connect(
            sort_name_action_, &QAction::triggered, this, [this]() { on_sort_mode_action_triggered(kSortActionName); });
        connect(
            sort_type_action_, &QAction::triggered, this, [this]() { on_sort_mode_action_triggered(kSortActionType); });
        connect(
            sort_date_action_, &QAction::triggered, this, [this]() { on_sort_mode_action_triggered(kSortActionDate); });
        connect(
            sort_size_action_, &QAction::triggered, this, [this]() { on_sort_mode_action_triggered(kSortActionSize); });
        ...
        connect(auto_refresh_action_, &QAction::triggered, this, [this]() { apply_runtime_settings(); });
        ...
        connect(path_combo_, QOverload<int>::of(&QComboBox::activated), this, [this](int index) {
        ...
        connect(
            path_combo_->lineEdit(), &QLineEdit::editingFinished, this, [this]() { sync_path_bar_from_current_dir(); });
    }
