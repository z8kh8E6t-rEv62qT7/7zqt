...
namespace z7::ui::filemanager {
    ...
    void MainWindow::setup_actions() {
        ...
        for (QAction* action :
             {sort_name_action_, sort_type_action_, sort_date_action_, sort_size_action_, unsorted_action_}) {
            action->setCheckable(true);
            sort_action_group_->addAction(action);
        }
        for (QAction* action :
             {time_day_action_, time_min_action_, time_sec_action_, time_ntfs_action_, time_ns_action_}) {
            action->setCheckable(true);
        ...
        archive_toolbar_->setIconSize(QSize(z7::platform::qt::toolbar_icon_extent(false, this),
        ...
        standard_toolbar_->setIconSize(QSize(z7::platform::qt::toolbar_icon_extent(false, this),
                                             z7::platform::qt::toolbar_icon_extent(false, this)));
