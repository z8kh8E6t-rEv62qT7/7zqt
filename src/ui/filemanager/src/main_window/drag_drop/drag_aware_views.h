...
namespace z7::ui::filemanager {
    ...
    public:
        using DragFinishedCallback = std::function<void(DragExecutionReport const&)>;
        using ArchiveDragMaterializedCallback = std::function<void(QStringList const&, QString const&)>;
        using ArchiveDragMaterializer = std::function<void(QStringList const&, ArchiveDragMaterializedCallback)>;
        using ArchiveDragDirectExporter = std::function<bool(QString const&, bool, QString const&, QString*)>;
