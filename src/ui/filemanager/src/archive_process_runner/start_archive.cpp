...
namespace z7::ui::filemanager {
    ...
    namespace {
        ...
        QString side_by_side_sfx_module_path() {
            return QDir(QCoreApplication::applicationDirPath()).filePath(QStringLiteral("7z.sfx"));
        }

    } // namespace

    bool ArchiveProcessRunner::start_compress(QString const& archive_path,
    ...
    bool ArchiveProcessRunner::start_add_to_archive(AddTaskOptions const& options) {
        ...
        for (ArchiveAddInputItem const& item : options.input_items) {
        ...
        return start_operation(
            QStringLiteral("Add"), QStringList{options.archive_path}, z7::app::ArchiveRequest{std::move(request)});
    }

    bool ArchiveProcessRunner::start_extract(QString const& archive_path,
        ...
        return start_operation(QStringLiteral("Extract"),
                               QStringList{archive_path, output_dir},
                               z7::app::ArchiveRequest{std::move(request)});
    }

    bool ArchiveProcessRunner::start_extract_many(QStringList const& archive_paths,
                                                  QString const& output_dir,
                                                  OverwriteMode overwrite_mode,
                                                  QString const& archive_type_hint,
                                                  z7::app::ExtractPathMode path_mode,
    ...
    bool ArchiveProcessRunner::start_extract_selected(QString const& archive_path,
                                                      QString const& output_dir,
                                                      OverwriteMode overwrite_mode,
        ...
        return start_operation(QStringLiteral("ExtractSelected"),
                               QStringList{archive_path, output_dir},
                               z7::app::ArchiveRequest{std::move(request)});
    }

    bool ArchiveProcessRunner::start_open_archive(QString const& archive_path,
        ...
        return start_operation(QStringLiteral("OpenArchive"),
                               QStringList{archive_path},
                               z7::app::ArchiveRequest{std::move(request)},
                               std::move(out_list_result));
    }

    bool ArchiveProcessRunner::start_test(QString const& archive_path) {
        z7::app::TestRequest request;
        request.archive_path = to_native_string(archive_path);
        apply_configured_extract_memory_limit(&request);

        return start_operation(
            QStringLiteral("Test"), QStringList{archive_path}, z7::app::ArchiveRequest{std::move(request)});
    }

    bool ArchiveProcessRunner::start_test_many(QStringList const& archive_paths) {
        if (archive_paths.isEmpty()) {
            return finish_immediately(z7::app::make_immediate_result(
                7, z7::app::ArchiveErrorDomain::kInvalidArguments, to_utf8_string(z7::ui::runtime_support::L(3015))));
        }
        ...
        return start_operation(QStringLiteral("Test"), archive_paths, z7::app::ArchiveRequest{std::move(request)});
    }

    bool ArchiveProcessRunner::start_test_entries(QString const& archive_path, QStringList const& archive_entries) {
    ...
    bool ArchiveProcessRunner::start_test_in_session(z7::app::ArchiveSessionToken token,
        ...
        return start_operation(
            QStringLiteral("TestInSession"), QStringList{}, z7::app::ArchiveRequest{std::move(request)});
    }

    bool ArchiveProcessRunner::start_delete_entries(QString const& archive_path,
                                                    QStringList const& archive_entries,
        ...
        return start_operation(
            QStringLiteral("Delete"), QStringList{archive_path}, z7::app::ArchiveRequest{std::move(request)});
    }

    bool ArchiveProcessRunner::start_archive_properties(QString const& archive_path,
                                                        QStringList const& archive_entries,
        ...
        return start_operation(
            QStringLiteral("Properties"), QStringList{archive_path}, z7::app::ArchiveRequest{std::move(request)});
    }
    ...
    bool
    ArchiveProcessRunner::start_list_in_session(z7::app::ArchiveSessionToken token,
                                                QString const& virtual_dir,
                                                bool recursive_dirs,
                                                bool include_detailed_props,
                                                std::shared_ptr<std::optional<z7::app::ListResult>> out_list_result) {
        ...
        return start_operation(QStringLiteral("ListInSession"),
                               QStringList{},
                               z7::app::ArchiveRequest{std::move(request)},
                               std::move(out_list_result));
    }
    ...
    bool ArchiveProcessRunner::start_extract_in_session(z7::app::ArchiveSessionToken token,
        ...
        return start_operation(
            QStringLiteral("ExtractInSession"), QStringList{output_dir}, z7::app::ArchiveRequest{std::move(request)});
    }
