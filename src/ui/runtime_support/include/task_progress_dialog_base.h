...
namespace z7::ui::runtime_support {
    ...
    struct TaskProgressDialogBehavior {
        ...
        char const* dialog_object_name = nullptr;
        char const* result_messages_view_object_name = nullptr;
        char const* background_button_object_name = nullptr;
        char const* pause_button_object_name = nullptr;
        char const* cancel_button_object_name = nullptr;
        char const* close_button_object_name = nullptr;
    };
    ...
    public:
        void set_header(QString const& text);
        void set_stage(QString const& text);
        ...
        void append_failure_result_message(QString const& message);
        void set_failure_result_messages(QStringList const& messages);
        void set_failure_result_mode();
        void set_cancel_confirmation_handler(std::function<int()> const& handler);
    ...
    protected:
        explicit TaskProgressDialogBase(TaskProgressDialogBehavior const& behavior, QWidget* parent = nullptr);
        void closeEvent(QCloseEvent* event) override;
        void reject() override;
        void set_result_mode_impl();

    private:
        QString label_text_with_optional_colon(QString const& text) const;
        void set_paused(bool paused);
        void set_backgrounded(bool backgrounded);
        void refresh_metrics();
        void update_title();
        void update_current_path_labels();
        void parse_progress_log_line(QString const& line);
