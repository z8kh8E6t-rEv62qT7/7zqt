...
namespace z7::ui::runtime_support {
    ...
    QString with_platform_suffix_if_unsupported(QString const& base_text, PlatformSupport support) {
    ...
    PlatformRestrictionUi platform_restriction_ui(QString const& base_text, PlatformSupport support) {
        bool const supported = is_platform_supported(support);
