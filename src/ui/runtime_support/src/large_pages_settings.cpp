...
namespace z7::ui::runtime_support {
    namespace {
        ...
        constexpr char const* kSettingsAppName = "7zFM";
        constexpr char const* kLargePagesKey = "LargePages";

        z7::platform::qt::PortableSettings app_settings() {
            return z7::platform::qt::PortableSettings(QString(), QString::fromLatin1(kSettingsAppName));
        }
    ...
    QString with_large_pages_platform_suffix_if_unsupported(QString const& text) {
    ...
    bool load_large_pages_enabled() {
        ...
        z7::platform::qt::PortableSettings const settings = app_settings();
