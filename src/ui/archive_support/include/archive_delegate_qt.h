...
namespace z7::ui::archive_support {
    ...
    TResult call_on_target_blocking(QObject* target, Prompt const& prompt, TResult default_result, Handler&& handler) {
    ...
    public:
        ...
        OutcomeRelayDelegate(QObject* primary_target,
                             ...
                             MissingTargetPolicy missing_target_policy = MissingTargetPolicy::kInvokeDirect);
    ...
    protected:
        ...
        OwnerRelayDelegate(TOwner* owner,
                           ...
                           QObject* fallback_target = nullptr,
                           MissingTargetPolicy missing_target_policy = MissingTargetPolicy::kInvokeDirect) :
            OutcomeRelayDelegate(owner, std::move(finished_cb), fallback_target, missing_target_policy),
            owner_(owner) {}

        TOwner* owner() const { return owner_.data(); }
