...
namespace z7::ui::archive_support {
    ...
    QuickLookExtractPlan build_quicklook_extract_plan(QString const& normalized_entry_path,
        ...
        QString const absolute_destination = QFileInfo(destination_path).absoluteFilePath();
        ...
        plan.path_remap.match_kind = entry_is_directory ? z7::app::ExtractPathRemapMatchKind::kArchivePrefix
