...
namespace z7::ui::archive_support {
    ...
    QString format_hhmmss(quint64 seconds) {
        quint64 const h = seconds / 3600;
        quint64 const m = (seconds % 3600) / 60;
        quint64 const s = seconds % 60;
    ...
    QString format_speed(quint64 completed_bytes, qint64 elapsed_ms) {
        ...
        quint64 const value = (completed_bytes * 1000ULL) / static_cast<quint64>(elapsed_ms);
