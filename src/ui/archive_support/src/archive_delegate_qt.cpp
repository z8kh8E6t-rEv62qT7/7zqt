...
namespace z7::ui::archive_support {
    ...
    void CompletionRelayDelegate::on_finished(z7::app::OperationOutcome const& outcome) {
        if (!finished_cb_) {
            return;
        }
    ...
    OutcomeRelayDelegate::OutcomeRelayDelegate(QObject* primary_target,
    ...
    void OutcomeRelayDelegate::on_lifecycle(z7::app::OperationStage stage, std::string_view message) {
    ...
    void OutcomeRelayDelegate::on_finished(z7::app::OperationOutcome const& outcome) {
        if (!finished_cb_) {
            return;
        }

        z7::app::OperationOutcome const copied = outcome;
