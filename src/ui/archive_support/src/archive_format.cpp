...
namespace z7::ui::archive_support {
    ...
    QString stage_label_for(z7::app::OperationStage stage) {
        switch (stage) {
            case z7::app::OperationStage::kPrepare:
                return z7::i18n::text(QStringLiteral("ui.state.operation_stage.prepare"));
            case z7::app::OperationStage::kRunning:
                return z7::i18n::text(QStringLiteral("ui.state.operation_stage.running"));
            case z7::app::OperationStage::kFinalizing:
                return z7::i18n::text(QStringLiteral("ui.state.operation_stage.finalizing"));
            case z7::app::OperationStage::kCompleted:
                return z7::i18n::text(QStringLiteral("ui.state.operation_stage.completed"));
        }
        return z7::i18n::text(QStringLiteral("ui.state.operation_stage.running"));
    }
    ...
    QString format_dual_size(uint64_t bytes) {
        return QStringLiteral("%1 bytes : %2").arg(QString::number(bytes), format_binary_size(bytes));
    }
