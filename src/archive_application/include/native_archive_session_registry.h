...
namespace z7::app {
    ...
    public:
        ...
        ArchiveOpenSession(ArchiveOpenSession const&) = delete;
        ArchiveOpenSession& operator=(ArchiveOpenSession const&) = delete;

        ArchiveSessionToken token() const { return token_; }

        std::string const& display_path() const { return display_path_; }

        OpenArchiveSessionResult::Strategy strategy() const { return strategy_; }
    ...
    private:
        ...
        std::shared_ptr<ArchiveOpenSession> register_session(std::shared_ptr<ArchiveOpenSession> session);
