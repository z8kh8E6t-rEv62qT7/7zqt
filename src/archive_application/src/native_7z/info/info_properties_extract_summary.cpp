...
namespace z7::app::info_properties_detail {
    ...
    void append_multi_selection_summary(CArc const& arc,
        ...
        for (SelectedPropertyItem const& item : selected_items) {
    ...
    void append_folder_properties(FolderPropertyContext const& folder_context,
        ...
        if (!folder_context.path_prefix.empty()) {
            UString const path_u = utf8_to_ustring(folder_context.path_prefix);
        ...
        {
            NWindows::NCOM::CPropVariant prop = static_cast<UInt64>(folder_context.num_sub_dirs);
            append_property_variant_original(out_lines,
                                             ArchivePropertySection::kCurrentFolder,
                                             ArchivePropertyDisplayGroup::kCurrentFolderProperties,
                                             std::nullopt,
        ...
        {
            NWindows::NCOM::CPropVariant prop = static_cast<UInt64>(folder_context.num_sub_files);
            append_property_variant_original(out_lines,
                                             ArchivePropertySection::kCurrentFolder,
                                             ArchivePropertyDisplayGroup::kCurrentFolderProperties,
                                             std::nullopt,
