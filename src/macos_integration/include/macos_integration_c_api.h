...
extern "C" {
    ...
    typedef struct z7_mi_selection {
        char const* const* selected_paths;
    ...
    typedef struct z7_mi_menu_plan {
        ...
        bool menu_visible;
        char const* base_folder;
        char const* extract_subdir;
    ...
    typedef struct z7_mi_quicklook_list_request {
        ...
        char const* virtual_dir;
        char const* archive_type_hint;
        char const* const* nested_archive_entries;
    ...
    typedef struct z7_mi_quicklook_batch_export_request {
        ...
        char const* const* nested_archive_entries;
        size_t nested_archive_entry_count;
        z7_mi_quicklook_batch_export_item_t const* items;
        size_t item_count;
    ...
    typedef struct z7_mi_quicklook_batch_export_progress {
        ...
        char const* current_entry_path;
        char const* current_destination_path;
        int current_percent;
        bool totals_known;
    ...
    typedef struct z7_mi_quicklook_batch_export_result {
        ...
        char const* failed_entry_path;
        char const* failed_destination_path;
    ...
    typedef void (*z7_mi_quicklook_batch_export_progress_callback_t)(z7_mi_quicklook_batch_export_progress_t* progress,
                                                                     void* user_data);

    typedef void (*z7_mi_quicklook_batch_export_callback_t)(z7_mi_quicklook_batch_export_result_t* result,
                                                            void* user_data);

    typedef void (*z7_mi_password_prompt_callback_t)(z7_mi_password_prompt_t* handle,
                                                     char const* archive_path,
                                                     char const* const* nested_chain,
                                                     size_t nested_chain_count,
                                                     char const* reason_key,
                                                     void* user_data);

    z7_mi_session_t* z7_mi_session_create(void);
    void z7_mi_session_destroy(z7_mi_session_t* session);
    void z7_mi_session_set_password_prompt_callback(z7_mi_session_t* session,
                                                    z7_mi_password_prompt_callback_t callback,
                                                    void* user_data);

    z7_mi_status_t
    z7_mi_build_menu_plan(z7_mi_session_t* session, z7_mi_selection_t const* selection, z7_mi_menu_plan_t* out_plan);
    ...
    void z7_mi_password_prompt_provide(z7_mi_password_prompt_t* handle, char const* password);
