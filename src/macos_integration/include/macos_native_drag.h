...
namespace z7::macos_integration::native_drag {
    ...
    struct MacOSIntegrationNativeDragItem {
        ...
        QString source_path;
        std::function<bool(QString const&, QString*)> write_to_destination;
    ...
    struct MacOSIntegrationNativeDragRequest {
        ...
        MacOSIntegrationNativeDragKind kind = MacOSIntegrationNativeDragKind::kArchive;
    ...
    MacOSIntegrationNativeDragResult
    run_macos_integration_native_drag(MacOSIntegrationNativeDragRequest const& request);
