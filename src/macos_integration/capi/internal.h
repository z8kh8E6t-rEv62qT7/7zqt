...
namespace z7::macos_integration::capi_internal {
    ...
    inline constexpr uint64_t kQuicklookBatchExportMaxBytes = 1ULL * 1024 * 1024 * 1024;
    ...
    void dispatch_result(TResult* result, TCallback callback, void* user_data) {
        ...
        dispatch_result_closure([result, callback, user_data]() { callback(result, user_data); });
    }
    ...
    ShellIntegrationConfig runtime_config_from_settings(MacOSIntegrationConfig const& config);
    ...
    void init_quicklook_batch_export_error(z7_mi_quicklook_batch_export_result_t* out_result,
                                           z7_mi_status_t status,
                                           QString const& error,
